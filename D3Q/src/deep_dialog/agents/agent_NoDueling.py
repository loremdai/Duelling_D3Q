...
from deep_dialog.qlearning import NoDueling


class Agent_NoDueling(Agent):
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, params=None):
        ...
        self.dqn = NoDueling(self.state_dimension, self.hidden_size, self.num_actions, self.n_step)
