...
class StateTracker:
    ...
    def initialize_episode(self):
        ...
        self.history_vectors = np.zeros((1, self.action_dimension))  # size:(1,10)
    ...
    def get_state_for_user(self):
        ...
        state = {'user_action': self.history_dictionaries[-2], 'current_slots': self.current_slots,
                 # 'kb_results': self.kb_results_for_state(),
                 'kb_results_dict': self.kb_helper.database_results_for_agent(self.current_slots),
                 'turn': self.turn_count, 'history': self.history_dictionaries,
