...
from deep_dialog.qlearning import DQN   # import的是pytorch版本的DQN
...
class AgentDQN(Agent):
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, params=None):
        ...
        self.dqn = DQN(self.state_dimension, self.hidden_size, self.num_actions)    # input_size, hidden_size(80), output_size
